 ...
 */
class VisualSource extends Visual {
  /**
  ...
  get ready (): boolean {
    ...
    const superProto = Object.getPrototypeOf(Object.getPrototypeOf(VisualSource.prototype))
...
export { VisualSource, VisualSourceOptions }
